                        ...
                        <div class="gc-container">
                            <div class="copyright-info">
                                ...
                                if( !empty( $footer_copyright_text ) ) {
                                    ...
                                    printf( esc_html__( '%1$s %2$s %3$s','gucherry-blog' ), $footer_copyright_text, '', '<a href="https://homeasking.com/" title="Решение бытовых домашних задач, помощь и советы" rel="nofollow" target="_blank">Homeasking.com</a>' );
                                } else {
                                    /* translators: 1: Theme name, 2: Theme author. */
                                    printf( esc_html__( '%1$s %2$s', 'gucherry-blog' ), '', '<a href="https://homeasking.com/" title="Решение бытовых домашних задач, помощь и советы" rel="nofollow" target="_blank">Homeasking.com</a>' );
                                }
                                ?> 
				                </p>
                            </div><!-- // copyright-info -->
